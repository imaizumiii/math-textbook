...
\begin{center}\textbf{「必要性からせめて$x = 0$を代入しようかな？」}\end{center}
\begin{center}
\makebox[\textwidth][s]{\textcolor{gray}{\hfill\leaders\hrule height 5pt\hfill} \textcolor{gray}{\Huge{◆}} \textbf{解答} \textcolor{gray}{\Huge{◆}} \textcolor{gray}{\hfill\leaders\hrule height 5pt\hfill}}
\end{center}
\vspace{0.5em}
