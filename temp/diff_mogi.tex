...
\noindent このタイミングで導関数を求める公式（定義）を紹介することにします。


\begin{tcolorbox}[before upper={\setlength{\abovedisplayskip}{5pt}\setlength{\belowdisplayskip}{5pt}\setlength{\abovedisplayshortskip}{0pt}\setlength{\belowdisplayshortskip}{0pt}}, title={導関数の求め方（定義）}]
関数$f(x)$の導関数$f'(x)$は以下のように定義される。\[ f'(x) = \lim_{h \to 0} \frac{f(x+h) - f(x)}{h} \]
\end{tcolorbox}
